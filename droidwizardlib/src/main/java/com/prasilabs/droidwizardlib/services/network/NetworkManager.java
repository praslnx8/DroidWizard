 ...
 */
package com.prasilabs.droidwizardlib.services.network;
...
public class NetworkManager extends BroadcastReceiver {
    ...
    {
        return new NetworkManager(context, null).isOnline();
    }
    ...
    public static boolean isConnectedToServer()
    {
        ...
        try {
            InetAddress address = InetAddress.getByName(C.RESTAPI.AppEngine.Login.CHECK_LOGIN_URL);
